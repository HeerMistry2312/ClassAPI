...
export class ProfileRouter{
  ...
  private configureRoutes(): void {
    this.router.post('/create',AuthMiddleware.authUser,ProfileController.createProfile);
    this.router.get('/getProfile/:id',AuthMiddleware.authUser,ProfileController.selectProfile)
